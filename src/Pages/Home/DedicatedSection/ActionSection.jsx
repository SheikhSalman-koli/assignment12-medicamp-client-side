...
export default function HomeActionSection() {
    ...
    return (
        <section id="action" className="py-12  bg-gray-100 rounded-2xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
                        ...
                        <button
                            ...
                            className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 transition mt-6 w-full "
                        >
                            Be a Volunteer
                        </button>
                    </div>
