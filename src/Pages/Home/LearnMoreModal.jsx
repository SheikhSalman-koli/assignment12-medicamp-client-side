...
export default function LearnMoreModal({ onClose }) {
    return (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
            <div className="bg-base-100 rounded-xl w-full max-w-2xl p-6 max-h-[90vh] overflow-y-auto shadow-xl">
                <div
                    className="flex justify-between">
                    <h2 className="text-2xl md:text-2xl font-semibold text-[#F97A00]  mb-4">
                        About MediCamp
                    </h2>
                    <button
                        onClick={onClose}
                ...
                <div>
                    ...
                    <ul className="list-disc pl-5 text-gray-500 mb-4 space-y-2">
